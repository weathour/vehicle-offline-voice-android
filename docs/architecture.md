...
- If `targetSdk` is raised to 34 or higher, add Android 14 microphone foreground-service permission requirements such as `FOREGROUND_SERVICE_MICROPHONE` and retest while-in-use permission behavior.
